...
$blog = PHP::selectSiteAllDateCIN('tb_site.blog', ($paginaAtual - 1) * $porPagina, $porPagina);
?>

<div class="pt-5">
    <h3 class="py-5">Blog</h3>
</div>
...
<div class="container-fluid table-responsive">
    ...
    <div class="paginacao">
        <?php
        $totalPaginas = ceil(count(PHP::selectSiteAllCIN('tb_site.blog')) / $porPagina);

        for ($i = 1; $i <= $totalPaginas; $i++) {
            if ($i == $paginaAtual)
                echo '<a class="page-selected" href="' . INCLUDE_PATH . 'blog?pagina=' . $i . '">' . $i . '</a>';
            else
