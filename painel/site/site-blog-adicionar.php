...
<div class="box-content">
    <h3><i class="fa fa-plus"></i> Adicionar Post</h3>
        ...
        <?php
            if (isset($_POST['acao'])) {
                ...
                if ($titulo == '' || $conteudo == '') {
                    ...
                    $verificar = MySql::conectar()->prepare("SELECT * FROM `tb_site.blog` WHERE CIN = ? AND titulo = ?");
                    ...
                    'slug'=>$slug,'nome_tabela'=>'tb_site.blog'];
                    if(PHP::insertOne($array)){
                        PHP::redirect(INCLUDE_PATH_PAINEL.'site-blog-adicionar?sucesso');
                    }
                    }else{
